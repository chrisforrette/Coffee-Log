...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_userprofile', (
            ...
            ('user', orm['users.UserProfile:user']),
            ('confirmation_hash', orm['users.UserProfile:confirmation_hash']),
            ('created', orm['users.UserProfile:created']),
            ('modified', orm['users.UserProfile:modified']),
            ('status', orm['users.UserProfile:status']),
        ))
    ...
    models = {
        ...
        'users.userprofile': {
            'confirmation_hash': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
